document.addEventListener('DOMContentLoaded', function() {
    ...
    labels.forEach(function(label) {
        ...
        switch (title) {
            case 'Modo Escuro':
                img.src = '2024.1-Minecraft/assets/icons/sol.png'; // Substitua pelo caminho da imagem para "Modo Escuro"
                break;
            case 'Modo Claro':
                img.src = '2024.1-Minecraft/assets/icons/lua.png'; // Substitua pelo caminho da imagem para "Outro Título"
                break;
        }
